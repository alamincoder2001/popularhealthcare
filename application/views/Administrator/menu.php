...
<?php } elseif ($module == 'SalesModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("sales_totalqtyrecord", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>sales_totalqtyrecord">
					<i class="menu-icon fa fa-list"></i>
					<span class="menu-text"> Sales Qty Record </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
	...
	<ul class="nav nav-list">
		...
		<li>
			<a href="<?php echo base_url(); ?>module/OrderModule" class="module_title">
		...
		<?php if (
			array_search("orderinvoice", $access) > -1
			|| array_search("returnList", $access) > -1
			|| array_search("sale_return_details", $access) > -1
			|| array_search("customerDue", $access) > -1
			|| isset($CheckSuperAdmin) || isset($CheckAdmin)
					...
					<?php if (array_search("reorder_list", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>reorder_list">
								<i class="menu-icon fa fa-caret-right"></i>
								<span class="menu-text"> Minimum Qnty List </span>
							</a>
							<b class="arrow"></b>
						</li>
					<?php endif; ?>
