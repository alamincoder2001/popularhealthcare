					...
					<tbody>
						<template v-for="purchase in purchases">
							<tr>
								...
								<td>{{ purchase.purchaseDetails[0].expire_date }}</td>
								<td>{{ purchase.purchaseDetails[0].manufac_date }}</td>
								<td>{{ purchase.purchaseDetails[0].batch_no }}</td>
							...
							<tr style="font-weight:bold;">
								<td colspan="8" style="font-weight:normal;"><strong>Note: </strong>{{ purchase.PurchaseMaster_Description }}</td>
