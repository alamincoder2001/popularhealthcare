...
<div id="cashStatement">
    ...
    <div id="printContent">
        ...
        <div class="row">
            <div class="col-md-12">
                <h4><span style="font-weight:600">Previous Day's Balance:</span> {{ cashBalance_2 }}</h4>
            </div>
        </div>
        ...
        <div class="row" style="padding-top:10px;">
            <div class="col-md-6">
                ...
                <table class="table table-bordered table-condensed" style="display: none;"
                    v-bind:style="{display: loanInitials.length > 0 ? '' : 'none'}">
                    <thead>
                        <tr style="background: #dee4dc;">
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                ...
                                <span style="display:none;"
                                    v-bind:style="{display: loanInitials.length > 0 ? '' : 'none'}">{{ totalInitialLoan | decimal }}</span>
                            </td>
                        </tr>
                    </tfoot>
                </table>
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                ...
                                <span style="display:none;"
                                    v-bind:style="{display: assetsSales.length > 0 ? '' : 'none'}">{{ totalAssetsSales | decimal }}</span>
                            </td>
                        </tr>
                    </tfoot>
                </table>
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                ...
                                <span style="display:none;"
                                    v-bind:style="{display: assetsCosts.length > 0 ? '' : 'none'}">{{ totalAssetsCost | decimal }}</span>
                            </td>
                        </tr>
                    </tfoot>
                </table>
...
new Vue({
    ...
    data() {
        return {
            ...
            sales_2: [],
            purchases_2: [],
            receivedFromCustomers_2: [],
            paidToCustomers_2: [],
            receivedFromSuppliers_2: [],
            paidToSuppliers_2: [],
            cashReceived_2: [],
            cashPaid_2: [],
            bankDeposits_2: [],
    ...
    computed: {
        ...
        // },
        cashBalance() {
            return ((parseFloat(this.totalCashIn) - parseFloat(this.totalCashOut)) + parseFloat(this
                .cashBalance_2)).toFixed(2);
        },

        //previous days
        totalSales_2() {
            return this.sales_2.reduce((prev, curr) => {
                return prev + parseFloat(curr.SaleMaster_PaidAmount)
            }, 0).toFixed(2);
        },
        totalPurchase_2() {
            return this.purchases_2.reduce((prev, curr) => {
                return prev + parseFloat(curr.PurchaseMaster_PaidAmount)
            }, 0).toFixed(2);
        },
        totalReceivedFromCustomers_2() {
            return this.receivedFromCustomers_2.reduce((prev, curr) => {
                return prev + parseFloat(curr.CPayment_amount)
            }, 0).toFixed(2);
        },
        totalPaidToCustomers_2() {
            return this.paidToCustomers_2.reduce((prev, curr) => {
                return prev + parseFloat(curr.CPayment_amount)
            }, 0).toFixed(2);
        },
        totalReceivedFromSuppliers_2() {
            return this.receivedFromSuppliers_2.reduce((prev, curr) => {
                return prev + parseFloat(curr.SPayment_amount)
            }, 0).toFixed(2);
        },
        totalPaidToSuppliers_2() {
            return this.paidToSuppliers_2.reduce((prev, curr) => {
                return prev + parseFloat(curr.SPayment_amount)
            }, 0).toFixed(2);
        },
        totalCashReceived_2() {
            return this.cashReceived_2.reduce((prev, curr) => {
                return prev + parseFloat(curr.In_Amount)
            }, 0).toFixed(2);
        },
        totalCashPaid_2() {
            return this.cashPaid_2.reduce((prev, curr) => {
                return prev + parseFloat(curr.Out_Amount)
            }, 0).toFixed(2);
        },
        totalBankDeposit_2() {
            return this.bankDeposits_2.reduce((prev, curr) => {
                return prev + parseFloat(curr.amount)
            }, 0).toFixed(2);
        },
        totalBankWithdraw_2() {
            return this.bankWithdraws_2.reduce((prev, curr) => {
                return prev + parseFloat(curr.amount)
            }, 0).toFixed(2);
        },

        totalLoanReceived_2() {
            return this.loanReceives_2.reduce((prev, curr) => {
                return prev + parseFloat(curr.amount)
            }, 0).toFixed(2);
        },

        totalLoanPayment_2() {
            return this.loanPayments_2.reduce((prev, curr) => {
                return prev + parseFloat(curr.amount)
            }, 0).toFixed(2);
        },

        totalInvestReceived_2() {
            return this.investReceives_2.reduce((prev, curr) => {
                return prev + parseFloat(curr.amount)
            }, 0).toFixed(2);
        },
        totalInvestPayment_2() {
            return this.investPayments_2.reduce((prev, curr) => {
                return prev + parseFloat(curr.amount)
            }, 0).toFixed(2);
        },
        totalEmployeePayments_2() {
            return this.employeePayments_2.reduce((prev, curr) => {
                return prev + parseFloat(curr.total_payment_amount)
            }, 0).toFixed(2);
        },
        totalAssetsCost_2() {
            return this.assetsCosts_2.reduce((prev, curr) => {
                return prev + parseFloat(curr.as_amount)
            }, 0).toFixed(2);
        },
        totalAssetsSales_2() {
            return this.assetsSales_2.reduce((prev, curr) => {
                return prev + parseFloat(curr.as_amount)
            }, 0).toFixed(2);
        },
        totalInitialLoan_2() {
            return this.loanInitials_2.reduce((prev, curr) => {
                return prev + parseFloat(curr.initial_balance)
            }, 0).toFixed(2);
        },
        totalCashIn_2() {
            return parseFloat(this.totalSales_2) +
                parseFloat(this.totalReceivedFromCustomers_2) +
                parseFloat(this.totalReceivedFromSuppliers_2) +
                parseFloat(this.totalCashReceived_2) +
                parseFloat(this.totalLoanReceived_2) +
                parseFloat(this.totalInvestReceived_2) +
                parseFloat(this.totalInitialLoan_2) +
                parseFloat(this.totalAssetsSales_2) +
                parseFloat(this.totalBankWithdraw_2);
        },
        totalCashOut_2() {
            return parseFloat(this.totalPurchase_2) +
                parseFloat(this.totalPaidToCustomers_2) +
                parseFloat(this.totalPaidToSuppliers_2) +
                parseFloat(this.totalCashPaid_2) +
                parseFloat(this.totalLoanPayment_2) +
                parseFloat(this.totalInvestPayment_2) +
                parseFloat(this.totalBankDeposit_2) +
                parseFloat(this.totalAssetsCost_2) +
                parseFloat(this.totalEmployeePayments_2);
        },
        cashBalance_2() {
            return (parseFloat(this.totalCashIn_2) - parseFloat(this.totalCashOut_2)).toFixed(2);
        }
    },
    created() {
        this.getStatements();
    ...
    methods: {
        ...
        getStatements_2() {
            this.getSales_2();
            this.getPurchases_2();
            this.getReceivedFromCustomers_2();
            this.getPaidToCustomers_2();
            this.getPaidToSuppliers_2();
            this.getReceivedFromSuppliers_2();
            this.getCashReceived_2();
            this.getCashPaid_2();
            this.getBankDeposits_2();
            this.getBankWithdraws_2();
            this.getLoanReceived_2();
            this.getLoanPayments_2();
            this.getInvestReceived_2();
            this.getInvestPayments_2();
            this.getEmployeePayments_2();
            this.getAssetsCost_2();
            this.getAssetsSales_2();
        },

        getSales() {
            axios.post('/get_sales', this.filter)
                .then(res => {
                    this.sales = res.data.sales.filter(s => parseFloat(s.SaleMaster_PaidAmount) > 0);
                })
        },
        ...
        getSales_2() {
            axios.post('/get_sales', this.filter2)
                .then(res => {
                    this.sales_2 = res.data.sales.filter(s => parseFloat(s.SaleMaster_PaidAmount) > 0);
                })
        },

        getPurchases_2() {
            axios.post('/get_purchases', this.filter2)
                .then(res => {
                    this.purchases_2 = res.data.purchases;
                })
        },

        getReceivedFromCustomers_2() {
            let filter = {
                dateFrom: this.filter2.dateFrom,
                dateTo: this.filter2.dateTo,
                paymentType: 'received'
            }
            axios.post('/get_customer_payments', filter)
                .then(res => {
                    this.receivedFromCustomers_2 = res.data.filter(p => p.CPayment_Paymentby != 'bank');
                })
        },

        getPaidToCustomers_2() {
            let filter = {
                dateFrom: this.filter2.dateFrom,
                dateTo: this.filter2.dateTo,
                paymentType: 'paid'
            ...
            axios.post('/get_customer_payments', filter)
                .then(res => {
                    this.paidToCustomers_2 = res.data.filter(p => p.CPayment_Paymentby != 'bank');
                })
        },

        getPaidToSuppliers_2() {
            let filter = {
                dateFrom: this.filter2.dateFrom,
                dateTo: this.filter2.dateTo,
                paymentType: 'paid'
            ...
            axios.post('/get_supplier_payments', filter)
                .then(res => {
                    this.paidToSuppliers_2 = res.data.filter(p => p.SPayment_Paymentby != 'bank');
                })
        },

        getReceivedFromSuppliers_2() {
            let filter = {
                dateFrom: this.filter2.dateFrom,
                dateTo: this.filter2.dateTo,
                paymentType: 'received'
            ...
            axios.post('/get_supplier_payments', filter)
                .then(res => {
                    this.receivedFromSuppliers_2 = res.data.filter(p => p.SPayment_Paymentby != 'bank');
                })
        },
        ...
        getBankWithdraws_2() {
            ...
            axios.post('/get_bank_transactions', filter)
                .then(res => {
                    this.bankWithdraws_2 = res.data;
                })
        },

        async getLoanReceived_2() {
            let filter = {
                dateFrom: this.filter2.dateFrom,
                dateTo: this.filter2.dateTo,
                transactionType: 'Receive'
            ...
            await axios.post('/get_loan_transactions', filter)
                .then(res => {
                    this.loanReceives_2 = res.data;
                })

            await axios.post('/get_loan_initial_balance', this.filter2).then(res => {
                this.loanInitials = res.data.accounts;
            })
        },
        getAssetsCost_2() {
            ...
            axios.post('/get_assets_cost', filter)
                .then(res => {
                    this.assetsCosts_2 = res.data.assets;
                })
        },
        getAssetsSales_2() {
            let filter = {
            ...
            axios.post('/get_assets_cost', filter)
                .then(res => {
                    this.assetsSales_2 = res.data.assets;
                })
        },
        getLoanPayments_2() {
            let filter = {
        ...
        getInvestReceived_2() {
            ...
            axios.post('/get_investment_transactions', filter)
                .then(res => {
                    this.investReceives_2 = res.data;
                })
        },
        ...
        getInvestPayments_2() {
            ...
            axios.post('/get_investment_transactions', filter)
                .then(res => {
                    this.investPayments_2 = res.data;
                })
        },

        getEmployeePayments_2() {
            let filter = {
                dateFrom: this.filter2.dateFrom,
                dateTo: this.filter2.dateTo,
                details: true
            ...
            axios.post('/get_payments', filter)
                .then(res => {
                    this.employeePayments_2 = res.data;
                })
        },
