...
<div class="col-xs-12">
	...
	<div class="col-sm-6">
		<div class="form-group" id="reOrderDiv" style="display:<?php echo $selected->is_service == 'true' ? 'none' : '';?>;">
			<label class="col-sm-4 control-label" for="form-field-1"> Minimum Quantity </label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="Re_Order" name="Re_Order" value="<?php echo $selected->Product_ReOrederLevel; ?>" placeholder="Minimum Quantity" class="form-control" />
