	...
	<div class="row">
		...
		<div class="form-horizontal">
			...
			<div class="col-sm-6">
				...
				<div class="form-group">
					<label class="col-sm-4 control-label" for="em_Category"> Category </label>
					<label class="col-sm-1 control-label">:</label>
					<div class="col-sm-5">
						<select class="chosen-select form-control" name="em_Category" id="em_Category" data-placeholder="Choose a Category...">
							...
							foreach ($categories as $cat) { ?>
								<option value="<?php echo $cat->ProductCategory_SlNo; ?>" <?php if ($selected->Category_ID == $cat->ProductCategory_SlNo) { ?> selected="selected" <?php } ?>><?php echo $cat->ProductCategory_Name; ?></option>
							<?php } ?>
						</select>
						<div id="em_Category_" class="col-sm-12"></div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-xs-5">
						<select class="chosen-select form-control" name="Reportingboss_Id" id="Reportingboss_Id" data-placeholder="Choose a Reporting Boss...">
							<option value=""> </option>
							<?php
							$employees = $this->db->query("SELECT * FROM tbl_employee WHERE Employee_SlNo != '$selected->Employee_SlNo' order by Employee_Name asc")->result();
							foreach ($employees as $emp) { ?>
								<option value="<?php echo $emp->Employee_SlNo; ?>" <?php echo $selected->Reportingboss_Id == $emp->Employee_SlNo ? "selected":"" ?>><?php echo $emp->Employee_Name; ?></option>
							<?php } ?>
						</select>
