    ...
    <div class="col-xs-12">
        ...
        <div class="form-horizontal">
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="employee_id"> Employee</label>
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-6">
                        <select class="chosen-select form-control" name="employee_id" id="employee_id" data-placeholder="Choose a Employee...">
                            <option value="<?php echo $selected->Employee_ID; ?>"><?php echo $selected->Employee_Name; ?></option>

                            <?php 
                                $employees =  $this->db->query("select * from tbl_employee e where e.status = 'a' order by Employee_Name asc")->result();
                                foreach($employees as $employee) {
                            ?>
                                <option value="<?php echo $employee->Employee_SlNo ?>"><?php echo $employee->Employee_Name ?></option>
                            <?php 
                                }
                            ?>
                        </select>
...
<script type="text/javascript">
    function Updatesubmit(){
        ...
        var inputdata = 'id='+id+'&username='+username+'&user_email='+user_email+'&rePassword='+rePassword+'&txtFirstName='+txtFirstName+'&Brunch='+Brunch+'&type='+type+'&employee_id='+employee_id+'&oldpassword='+oldpassword;
