	...
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
		<div class="row">
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<v-select v-bind:options="employees" v-model="selectedEmployee" label="Employee_Name" placeholder="Select Employee" :disabled="userType=='e' ? true : false"></v-select>
				</div>
			</div>

			<div class="form-group">
				<label class="col-sm-1 control-label no-padding-right"> Ordre From </label>
				<div class="col-sm-2">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group clearfix" style="margin-bottom: 8px;">
								<label class="col-xs-3 control-label no-padding-right"> Order Type </label>
								<div class="col-xs-9">
							...
							<div class="form-group">
								<label class="col-xs-3 control-label no-padding-right"> Customer </label>
								<div class="col-xs-8">
									<v-select v-bind:options="computedCustomer" label="display_name" v-model="selectedCustomer" v-on:input="customerOnChange"></v-select>
								</div>
						...
						<div class="col-sm-6">
							<form v-on:submit.prevent="addToCart">
								<div class="form-group">
									...
									<div class="col-xs-8">
										<v-select v-bind:options="selectedEmployee.Category_ID != '' ? computedProducts : filterProducts" v-model="selectedProduct" label="display_text" v-on:input="productOnChange"></v-select>
									</div>
									<div class="col-xs-1" style="padding: 0;">
				...
				<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
					<thead>
						<tr class="">
							...
							<th style="width:10%;color:#000;">Batch No</th>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-xs-6">
													<a class="btn btn-info btn-sm" v-bind:href="`/order_entry`" style="color: black!important;margin-top: 0px;width:100%;padding:5px;font-weight:bold;">New Order</a>
												</div>
											</div>
										</td>
									</tr>
		...
		methods: {
			getEmployees() {
				axios.get('/get_employees').then(res => {
					...
					if (this.userType == 'e') {
						this.selectedEmployee = res.data.find(emp => emp.Employee_SlNo == this.employeeId)
					}
				})
			},
			getBranches() {
