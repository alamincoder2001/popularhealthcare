...
<div id="userAccess">
    ...
    <div class="row" id="accessRow">
        <div class="col-md-3">
            ...
            <div class="group">
                <input type="checkbox" id="order" class="group-head" @click="onClickGroupHeads"> <strong>Order</strong>
                <ul ref="order">
                    ...
                    <li><input type="checkbox" class="access" value="orderinvoice" v-model="access"> Order Invoice</li>
                    <li><input type="checkbox" class="access" value="delivery_order" v-model="access"> Order Delivery List</li>
                </ul>
            </div>
        ...
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="purchaseReports">
                    ...
                    <li><input type="checkbox" class="access" value="reorder_list" v-model="access"> Minimum Quantity List</li>
                </ul>
            </div>
            <div class="group">
