...
<div id="customers">
		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom:15px;">
			<div class="col-md-5">
				...
				<div class="form-group clearfix">
					<label class="control-label col-md-4">Derma Division:</label>
					<div class="col-md-7">
						<v-select v-bind:options="dermaemployees" v-model="selectedEmployeeDarma" label="Employee_Name"></v-select>
					</div>
				...
				<div class="form-group clearfix">
					<label class="control-label col-md-4">Nutrition Division:</label>
					<div class="col-md-7">
						<v-select v-bind:options="nutritionemployees" v-model="selectedEmployeeNutrition" label="Employee_Name"></v-select>
					</div>
					<div class="col-md-1" style="padding:0;margin-left: -15px;"><a href="/employee" target="_blank" class="add-button"><i class="fa fa-plus"></i></a></div>
				</div>
				<div class="form-group clearfix">
					<label class="control-label col-md-4">Healthcare Division:</label>
					<div class="col-md-7">
						<v-select v-bind:options="healthcareemployees" v-model="selectedEmployeeHealthcare" label="Employee_Name"></v-select>
					</div>
					<div class="col-md-1" style="padding:0;margin-left: -15px;"><a href="/employee" target="_blank" class="add-button"><i class="fa fa-plus"></i></a></div>
				</div>
			</div>	
			...
			<div class="col-md-5">
				...
				<div class="form-group clearfix" v-if="selectedEmployeeDarma != null && selectedEmployeeDarma.Employee_Name != null">
					<label class="control-label col-md-4">Derma Due:</label>
					<div class="col-md-7">
						<input type="number" class="form-control" v-model="customer.derma_due" required>
					</div>
				</div>
				<div class="form-group clearfix" v-if="selectedEmployeeNutrition != null && selectedEmployeeNutrition.Employee_Name != null">
					<label class="control-label col-md-4">Nutrition Due:</label>
					<div class="col-md-7">
						<input type="number" class="form-control" v-model="customer.nutrition_due" required>
					</div>
				</div>
				<div class="form-group clearfix" v-if="selectedEmployeeHealthcare != null && selectedEmployeeHealthcare.Employee_Name != null">
					<label class="control-label col-md-4">Healthcare Due:</label>
					<div class="col-md-7">
						<input type="number" class="form-control" v-model="customer.healthcare_due" required>
					</div>
				</div>
	...
	new Vue({
		...
		data(){
			return {
				...
				nutritionemployees: [],
				healthcareemployees: [],
				selectedEmployeeDarma: null,
				selectedEmployeeNutrition: null,
				selectedEmployeeHealthcare: null,
				imageUrl: '',
				selectedFile: null,
		...
		methods: {
			...
			getEmployees(){
				axios.get('/get_employees').then(res => {
					this.dermaemployees = res.data.filter(e => {return e.Department_ID == 1});
					this.nutritionemployees = res.data.filter(e => {return e.Department_ID == 3});
					this.healthcareemployees = res.data.filter(e => {return e.Department_ID == 2});
				})
			},
			previewImage(){
			...
			saveCustomer(){
				...
				if(this.selectedEmployeeDarma == null && this.selectedEmployeeHealthcare == null && this.selectedEmployeeNutrition == null){
					alert('Select Employee');
					return;
				}

				this.customer.area_ID = this.selectedDistrict.District_SlNo;
				this.customer.Derma_Id = this.selectedEmployeeDarma == null ? "":this.selectedEmployeeDarma.Employee_SlNo;
				this.customer.Nutrition_Id = this.selectedEmployeeNutrition == null ? "":this.selectedEmployeeNutrition.Employee_SlNo;
				this.customer.Healthcare_Id = this.selectedEmployeeHealthcare == null ? "":this.selectedEmployeeHealthcare.Employee_SlNo;
			...
			editCustomer(customer){
				...
				this.selectedEmployeeDarma = {
					Employee_SlNo: customer.employee_ID,
					Employee_Name: customer.derma_employee
				}
				this.selectedEmployeeNutrition = {
					Employee_SlNo: customer.employee_ID,
					Employee_Name: customer.nutrition_employee
				}
				this.selectedEmployeeHealthcare = {
					Employee_SlNo: customer.employee_ID,
					Employee_Name: customer.healthcare_employee
				}
			...
			resetForm(){
				...
				this.imageUrl = '';
				this.selectedFile = null;
				this.selectedEmployeeDarma = null
				this.selectedEmployeeNutrition = null
				this.selectedEmployeeHealthcare = null
