...
class Model_Table extends CI_Model
{
    ...
    public function getTransactionSummary($date = null, $branchId = null)
    {
        ...
        $transactionSummary = $this->db->query("
            ...
            (
                ...
                where sm.Status = 'a'
                " . ($branchId == '' ? "" : " and sm.SaleMaster_branchid = '$branchId' ") . "
            ...
            (
                ...
                " . ($branchId == '' ? "" : " and cp.CPayment_brunchid = '$branchId' ") . "
            ...
            (
                ...
                " . ($branchId == '' ? "" : " and sp.SPayment_brunchid = '$branchId' ") . "
            ...
            (
                ...
                and ct.status = 'a'
                " . ($branchId == '' ? "" : " and ct.Tr_branchid = '$branchId' ") . "
            ...
            (
                ...
                and bt.status = 1
                " . ($branchId == '' ? "" : " and bt.branch_id = '$branchId' ") . "
            ...
            (
                ...
                where la.status = 1
                " . ($branchId == '' ? "" : " and la.branch_id = '$branchId' ") . "
            ...
            (
                ...
                where ass.status = 'a'
                " . ($branchId == '' ? "" : " and ass.branchid = '$branchId' ") . "
            ...
            (
                ...
                where pm.status = 'a'
                " . ($branchId == '' ? "" : " and pm.PurchaseMaster_BranchID = '$branchId' ") . "
            ...
            (
                ...
                where ep.status = 'a'
                " . ($branchId == '' ? "" : " and ep.branch_id = '$branchId' ") . "
    ...
    public function getBankTransactionSummary($accountId = null, $date = null, $branchId = null)
    {
        $bankTransactionSummary = $this->db->query("
            ...
            " . ($branchId == '' ? "" : " where ba.branch_id = '$branchId' ") . "
    ...
    public function getLoanTransactionSummary($accountId = null, $date = null, $branchId = null)
    {
        $loanTransactionSummary = $this->db->query("
            select 
                ...
                (
                    ...
                    and lt.status = 1
                    " . ($branchId == '' ? "" : " and lt.branch_id = '$branchId' ") . "
            ...
            " . ($branchId == '' ? "" : " where la.branch_id = '$branchId' ") . "
    ...
    public function getInvestmentTransactionSummary($accountId = null, $date = null, $branchId = null)
    {
    ...
    public function assetsReport($clauses = '', $date = null, $branchId = null)
    {
    ...
    public function currentStock($clauses = '', $branchId = null)
    {
        $stock = $this->db->query("
            select * from(
                select
                    ...
                    (select (p.Product_SellingPrice * current_quantity)) as sale_stock_value,
                ...
                " . ($branchId == '' ? "" : " and ci.branch_id = '$branchId' ") . "
            ) as tbl
            where 1 = 1
            $clauses
        ")->result();
    ...
    public function supplierDue($clauses = "", $date = null, $branchId = null)
    {
        ...
        $supplierDues = $this->db->query("
            ...
            from tbl_supplier s
            " . ($branchId == '' ? "" : " where s.Supplier_brinchid = '$branchId' ") . " 
    ...
    public function customerDue($clauses = "", $date = null, $branchId = null)
    {
