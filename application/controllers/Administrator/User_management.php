...
class User_management extends CI_Controller {
    ...
    public function edit($id) {
        ...
        $query = $this->db->query("SELECT tbl_user.*,tbl_brunch.*, tbl_employee.Employee_Name FROM tbl_user left join tbl_brunch on tbl_brunch.brunch_id=tbl_user.userBrunch_id left join tbl_employee on tbl_employee.Employee_SlNo = tbl_user.Employee_ID WHERE tbl_user.User_SlNo = '$id'");
