...
class Customer extends CI_Controller
{
    ...
    public function getCustomers(){
        ...
        $customers = $this->db->query("
            select
                c.*,
                d.District_Name,
                da.Employee_Name as derma_employee,
                nu.Employee_Name as nutrition_employee,
                he.Employee_Name as healthcare_employee,
            ...
            left join tbl_employee da on da.Employee_SlNo = c.Derma_Id
            left join tbl_employee nu on nu.Employee_SlNo = c.Nutrition_Id
            left join tbl_employee he on he.Employee_SlNo = c.Healthcare_Id
            where c.status = 'a'
    ...
    public function getCustomerPayments(){
        ...
        $payments = $this->db->query("
            ...
            left join tbl_employee e on e.Employee_SlNo = cp.CPayment_employeeID
            where cp.CPayment_status = 'a'
